...
public class BranchServiceProvider implements BranchService {
    ...
    @Override
    public EmptyResult lockBranch(LockBranchOrder order) {
        return serviceEngine.execute("lockBranchService", order);
    }

    @Override
    public EmptyResult unLockBranch(UnLockBranchOrder order) {
        return serviceEngine.execute("unLockBranchService", order);
    }
}
