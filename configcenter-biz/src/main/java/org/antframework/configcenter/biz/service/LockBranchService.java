...
@AllArgsConstructor
public class LockBranchService {

    // 分支dao
    private final BranchDao branchDao;

    @ServiceBefore
    public void before(ServiceContext<LockBranchOrder, EmptyResult> context) {
        LockBranchOrder order = context.getOrder();
        // 校验入参
    ...
    @ServiceExecute
    public void execute(ServiceContext<LockBranchOrder, EmptyResult> context) {
        LockBranchOrder order = context.getOrder();
