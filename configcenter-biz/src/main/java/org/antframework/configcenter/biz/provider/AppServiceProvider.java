...
public class AppServiceProvider implements AppService {
    ...
    public QueryAppsResult queryApps(QueryAppsOrder order) {
        CommonQueries.CommonQueryResult result = serviceEngine.execute(CommonQueries.SERVICE_NAME, order, QueryUtils.buildCommonQueryAttachmentByUpdateTime(AppDao.class));
