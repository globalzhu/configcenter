...
public class BranchServiceTest extends AbstractTest {
    ...
    public void testReleaseBranch() {
        for (String branchId : BRANCH_IDS) {
            ...
            propertyChange.getAddedOrModifiedProperties().add(new Property("redis.host", "localhost", Scope.PRIVATE, ValueType.PRODUCT_FEATURE_VALUE));
            propertyChange.getAddedOrModifiedProperties().add(new Property("redis.port", "6379", Scope.PRIVATE, ValueType.PRODUCT_FEATURE_VALUE));
