...
public interface PropertyValueDao {
    ...
    @Cacheable(cacheNames = CacheConstant.ALL_PROPERTY_VALUES_CACHE_NAME, key = "#p1 + ',' + #p2")
    List<PropertyValue> findByProfileIdAndBranchId(String profileId, String branchId);
}
