...
<div id="branchesApp">
    ...
    <el-dialog :visible.sync="addBranchDialogVisible" :before-close="closeAddBranchDialog" title="新增分支(GAIA命名规范：GAIA-版本号-备注，例：GAIA-1.5.4.8-主线/XX客户定制功能。版本号如果是五位，则为bugfix版本，第五位必须从101开始)" width="50%">
        <el-form ref="addBranchForm" :model="addBranchForm" label-width="20%">
            ...
            <el-form-item label="源分支id" prop="sourceBranchId" :rules="[{required:true, message:'请输入源分支id', trigger:'blur'}]">
                <el-select v-model="addBranchForm.sourceBranchId" filterable clearable placeholder="请输入源分支id" style="width: 90%">
